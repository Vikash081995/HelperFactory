...
const tenX = Array(10).fill("X");
console.log(tenX); //["X", "X", "X", "X", "X", "X", "X", "X", "X", "X"]
...
// if it exists it return the index else it returns -1
//==============================================
...
//========================================
//lastIndexOf():to check if an item exist in an array.
// If it exist it returns
...
// If it exist it returns true else it returns false.
//========================================
...
// the argument we passed in the join method will be joined in the array
// and return as a string. By default, it joins with a comma,
...
//Starting position, number of times to be removed
